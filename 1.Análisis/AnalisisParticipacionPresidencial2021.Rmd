...
Las demostraciones de este documento utilizan principalmente el paquete `ggplot2` pero también nos apoyaremos en algunas funciones de `dplyr` que veremos en la segunda clase y otros paquetes que permiten aumentar el potencial de las visualizaciones.
...
# Distribución en la participación
